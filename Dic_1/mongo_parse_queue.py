...
class MongoParseQueue:
    ...
    def __init__(self, client=None, timeout=300):
        ...
        self.db = self.client.parse_queue_db  # set the db using for queue
    ...
    def __nonzero__(self):
        ...
        """
        record = self.db.parse_queue.find_one(
    ...
    def push(self, url, html):
        ...
        """
        try:
            self.db.parse_queue.insert({'_id': url, 'html': html, 'status': self.OUTSTANDING})
    ...
    def pop(self):
        ...
        """
        record = self.db.parse_queue.find_and_modify(
    ...
    def complete(self, url):
        ...
        self.db.parse_queue.update({'_id': url}, {'$set': {'status': self.COMPLETE}})
